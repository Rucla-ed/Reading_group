...
lastname <- function(x) {
  print(x)
  message("Don't forget hyphens")
}

lastname("Martin Varela")
```
...
```{r}
message("Hey", " you", " what's up?", appendLF = T)
cat("Hey","you")
```
    
ANSWER: `appendLF` appends two or more character strings together similar to the `cat()` function.
...
```{r}
m1 <- catch_cnd(stop("This is an error message"))

str(m1)

#Not able to assign error message
m2 <- stop("This is error message 2")
...
catch_cnd(10)
catch_cnd(stop("stop!"))
catch_cnd(message("This is a message"))
```
